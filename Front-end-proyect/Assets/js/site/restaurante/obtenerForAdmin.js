    ...
    <div class="card border-0 shadow-sm h-100 rounded-4 overflow-hidden">
      ...
      <div class="card-body d-flex flex-column">
        ...
        <button class="btn btn-outline-warning btn-sm px-3"> 
         <a href="/Assets/view/Admin/restaurante/edit.html?id=${r.id}" class="text-decoration-none">     
            <i class="bi bi-pencil"></i>
          </a>
        </button>


         <a href="/Assets/view/Admin/restaurante/delete.html?id=${r.id}" class="text-decoration-none"> 
