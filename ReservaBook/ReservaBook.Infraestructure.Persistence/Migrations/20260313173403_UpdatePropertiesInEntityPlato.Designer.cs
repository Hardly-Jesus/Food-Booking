...
namespace ReservaBook.Infraestructure.Persistence.Migrations
{
    ...
    [Migration("20260313173403_UpdatePropertiesInEntityPlato")]
    partial class UpdatePropertiesInEntityPlato
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ReservaBook.Core.Domain.Entities.Plato", b =>
                {
                    ...
                    b.HasOne("ReservaBook.Core.Domain.Entities.Menu", null)
                        .WithMany("PlatosList")
                        .HasForeignKey("MenuId");

                    b.HasOne("ReservaBook.Core.Domain.Entities.Pedido", null)
                        .WithMany("Platos")
